...
// ── Ordered dithering (Bayer 8×8) to match PostLines shader aesthetic ──
const BAYER_8x8 = [
...
function applyDither(ctx, w, h, { scale, threshold, inkColor, brightness, contrast }) {
    ...
    <>
      <div className="backpack-icon" onClick={handleBackpackClick}>
        {collectedLetters.length > 0 && (
          <div className="backpack-badge">{collectedLetters.length}</div>
        )}
